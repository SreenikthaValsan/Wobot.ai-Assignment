export const CameraTableHeader = () => (
  <thead>
    <tr>
      ...
      <th className="px-4 py-3 text-left text-md font-medium text-gray-500 uppercase tracking-wider">Health</th>
      <th className="px-4 py-3 text-centre text-md font-medium text-gray-500 uppercase tracking-wider">Location</th>
      <th className="px-4 py-3 text-centre text-md font-medium text-gray-500 uppercase tracking-wider">Recorder</th>
      <th className="px-4 py-3 text-centre text-md font-medium text-gray-500 uppercase tracking-wider">Tasks</th>
